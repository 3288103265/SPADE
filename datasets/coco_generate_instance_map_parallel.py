...
parser.add_argument('--input_label_dir', type=str, default="./train_map/",
...
parser.add_argument('--output_instance_dir', type=str, default="./train_inst_parallel/",
...
num_cores = 80
Parallel(n_jobs=num_cores, require='sharedmem')(delayed(loop)(ix, id) for ix, id in enumerate(imgIds))
